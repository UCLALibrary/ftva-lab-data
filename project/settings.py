...
MIDDLEWARE = [
    ...
    # Enable tracking of who makes changes via simple_history
...
DEFAULT_FROM_EMAIL = os.getenv("DJANGO_EMAIL_FROM_ADDRESS")

# Airtable configuration
AIRTABLE_APP_ID = os.getenv("AIRTABLE_APP_ID")
AIRTABLE_SHARE_ID = os.getenv("AIRTABLE_SHARE_ID")
AIRTABLE_URL = f"https://airtable.com/{AIRTABLE_APP_ID}/{AIRTABLE_SHARE_ID}"
